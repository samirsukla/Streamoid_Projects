...
public class OutfitterVTargetV2Test {
	static String url = "https://outfitter.service.streamoid.com/insecure/outfitter/v_target/52929107?v=2";
  @Test
  public void outfitterTargetV2() throws ParseException, IOException {
		...
		else
		{
			...
			sc.close();
			InputStream inputStream = new FileInputStream(new File ("src/test/resources/OutfitterVTarget_v2.json"));
