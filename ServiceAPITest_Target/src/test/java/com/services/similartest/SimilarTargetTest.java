...
public class SimilarTargetTest {
	static String url = "https://similar.service.streamoid.com/v1/similar/refine-by/target/52929107";
  @Test
  public void similarAPITarget() throws ParseException, IOException {
		...
		else
		{
			...
			sc.close();
			InputStream inputStream = new FileInputStream(new File ("src/test/resources/SimilarTargetPID.json"));
