...
public class SendStatusReport {
	...
	String[] sendCCPass = new String[] { "prashant.gupta@streamoid.com","krupa@streamoid.com" };
	String[] sendCCFail = new String[] { "sar@streamoid.com", "prathaban@streamoid.com",
			"prashant.gupta@streamoid.com","krupa@streamoid.com" };
...
//		System.out.println("Test Status is " + testStatus);
	...
	public boolean sendMailStatus() throws IOException {
		...
		Element tbody = table.select("tbody").get(1);
