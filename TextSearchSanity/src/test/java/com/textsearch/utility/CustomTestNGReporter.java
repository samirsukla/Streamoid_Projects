...
//				retBuf.append("<tr><td colspan=7><center><b>" + tempSuite.getName() + "</b></center></td></tr>");
	...
	private String updateTestResult(IResultMap testResultMap) throws IOException
	{
		...
		for(ITestResult testResult : testResultSet)
		{	
			ExtractInfoFromExcel extract = new ExtractInfoFromExcel();
			...
			for(int i=0;i<rows;i++) {
				...
				String noOfDiff = map.get("noOfDiff").get(i);
				...
				retStrBuf.append("<td align=\"center\">");
				retStrBuf.append(noOfDiff);
				retStrBuf.append("</td>");
				
				retStrBuf.append("<td align=\"center\">");
				retStrBuf.append(expectedList);
				retStrBuf.append("</td>");
				
				retStrBuf.append("<td align=\"center\">");
				retStrBuf.append(actualList);
				retStrBuf.append("</td>");
